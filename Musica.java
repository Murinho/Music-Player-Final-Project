...
public class Musica extends javax.swing.JFrame {
     ...
     */
    static String filePath = "03 Kids With Guns.wav";
    Long currentFrame;
    Clip clip;
    String status;
    ...
    private void initComponents() throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        list = new List();
        list.addSong("03 Kids With Guns.wav");
        list.addSong("04 O Green World(1).wav");
        list.addSong("09 November Has Come.wav");
        list.addSong("13 Fire Coming Out of the Monkey's Head.wav");
        list.addSong("14 Don't Get Lost In Heaven.wav"); 
        filePath = list.playCurrentSong();               
        ...
        jLabel1.setText(list.playCurrentSong());
